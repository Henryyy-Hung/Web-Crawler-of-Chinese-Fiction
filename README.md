...
* 备注：本软件免费且无毒。若出现任何问题，一是没按操作来，二是用了【[**支援的网站**](#支援的网站 "Goto 支援的网站")】以外的网站，三是在繁忙时间使用，网站伺服器处理不过来。源代码在[src](https://github.com/Henryyy-Hung/Web-Crawler-of-Chinese-Fiction/tree/main/src)文件夹中
